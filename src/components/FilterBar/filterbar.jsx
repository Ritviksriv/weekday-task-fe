      ...
      <Box className={styles['filter-container']}>
        <Grid container spacing={2} justifyContent="center">
          <Grid item xs={12} sm={6} md={4} lg={2}>
            < GenericAutocomplete multiple={true} options={ROLES_OPTIONS_MAP}  label="Roles"/>
          </Grid>
          <Grid item xs={12} sm={6} md={3} lg={2}>
            < GenericAutocomplete multiple={true} options={HEADCOUNT_OPTIONS_MAP}  label="Number of Employees"/>
          </Grid>
          <Grid item xs={12} sm={6} md={4} lg={2}>
            < GenericAutocomplete multiple={false} options={EXPERIENCE_OPTIONS_MAP} label="Experience"/>
          </Grid>
          <Grid item xs={12} sm={6} md={4} lg={2}>
            < GenericAutocomplete multiple={true}  options={MODE_OPTIONS_MAP} label="Mode" />
          </Grid>
          <Grid item xs={12} sm={6} md={4} lg={2}>
            < GenericAutocomplete options={SALARY_OPTIONS_MAP} multiple={true} label="Minimum Base Pay Salary" />
          </Grid>
          <Grid item xs={12} sm={6} md={4} lg={2}>
